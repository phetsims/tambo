...
class SoundManager extends PhetioObject {
  ...
  public constructor( tandem?: Tandem ) {
    ...
    this.enabledProperty = new BooleanProperty( window.phet?.chipper?.queryParameters?.supportsSound || false, {
    ...
    this.extraSoundEnabledProperty = new BooleanProperty( window.phet?.chipper?.queryParameters?.extraSoundInitiallyEnabled || false, {
